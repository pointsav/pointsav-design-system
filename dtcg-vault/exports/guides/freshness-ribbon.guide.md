...
### HTML
```html
<h2 class="ps-article__section-heading">Section title<span class="ps-freshness-ribbon ps-freshness-ribbon--{{stop}}" data-source="{{source}}" data-iso="{{date}}" aria-label="Last reviewed {{date}} — {{stop}}">{{date}}</span></h2>
```
