...
**Source:** research-wikipedia-toolbar-mobile.draft.md (project-knowledge, 2026-05-07)
**Authors:** task-project-knowledge (Opus parent + Sonnet sub-agent research)
**Cites:** mediawiki.org/wiki/Skin:Vector/2022, MediaWiki design documentation, Skin:MinervaNeue, MobileFrontend extension docs

---

This research provides the engine-gap analysis that grounds Sprint G through Sprint K of
the Wikipedia muscle-memory implementation roadmap. It pairs with the broader
`wikipedia-leapfrog-2030.md` research record (homepage, token vocabulary, competitive
landscape). This record is scoped specifically to toolbar navigation, responsive collapse,
and the mobile UX patterns the engine needs next.
