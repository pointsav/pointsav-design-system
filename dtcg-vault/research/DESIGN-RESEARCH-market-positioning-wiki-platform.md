# Design Research — Market Positioning, app-mediakit-knowledge

**Source:** DESIGN-RESEARCH-market-positioning-wiki-platform.draft.md (totebox@project-knowledge, 2026-05-24)
**Language protocol:** DESIGN-RESEARCH
**Research trail:** competitive analysis · Hugo / MediaWiki / Q4 Inc · leapfrog 2030
**Audience:** internal (bcsc-review required before any public use)
**ai_consumption_hint:** Strategic positioning research for app-mediakit-knowledge vs Hugo, MediaWiki, and Q4 Inc. Documents 7 structural gaps Hugo cannot fill, MediaWiki's technical debt and regulated-data liabilities, Q4's complement play, and 5 Leapfrog 2030 lock-in capabilities. Positioning statement for internal design use only — not for public-facing content without BCSC review.
