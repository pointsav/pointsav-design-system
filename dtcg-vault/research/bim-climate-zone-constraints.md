...
**Source:** design-research-climate-zone-constraints.draft.md (project-bim, 2026-05-06)
...
The zone entity is related to constrained elements via `IfcRelAssociatesConstraint`,
which links an `IfcSpatialZone` to `IfcMetric` records encoding the performance
requirements.
