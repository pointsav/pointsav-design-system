<!-- source: clones/project-design/.agent/drafts-outbound/research-ps-badge-favicon-design-2026-05-08.draft.md
     ai_consumption_hint: design decision record — PS badge favicon for design.pointsav.com;
     rationale for SVG format, viewBox, rx, fill, dominant-baseline, font choices -->
...
The standalone SVG file is committed to `pointsav-media-assets/icons/ps-badge-favicon.svg`
at commit `6d58f07`.
